...
var stextd = [
    [
        ...
        {t: [
            'since May 2019<tspan x="' + tab1 + '">Google DeepMind</tspan>',
            '<tspan style="font-style: italic" x="' + tab1 + '"><tspan fill="' + colpHigh + '">Data Engineer</tspan></tspan>',
            ' ',
    ...
    [
        ...
        {t:[
            '<tspan fill="' + colpHigh + '">Data Engineer</tspan> - Google DeepMind',
