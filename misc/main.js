...
var stextd = [
    [
        ...
        {t: [
            ...
            '<tspan style="font-style: italic" x="' + tab1 + '"><tspan fill="' + colpHigh + '">Senior Software Engineer</tspan></tspan>',
            ' ',
    ...
    [
        ...
        {t:[
            '<tspan fill="' + colpHigh + '">Senior Software Engineer</tspan> - Google DeepMind',
...
var skeywd = [
    [
        ...
        {t:'Google',
        l:slined.lyell.p[1], r:45, dx:-9*Gth, dy:2*Geg},
        {t:'PsyCONNECT',
        l:slined.lyell.p[0], r:45, dx:-8*Gth, dy:-Geg},
        {t:'Python, C++, Protobuf, HTML/CSS/Javascript, LaTeX, Mplus, SPSS, Stata',
